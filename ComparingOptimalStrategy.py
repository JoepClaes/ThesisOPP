...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  6 17:14:32 2025

@author: jawclaes
"""

# THIS FILE CALCULATES THE OPTIMAL DEPTH AND STOPPING TIME AND THEN SIMULATES THAT STRATEGY OVER 10,000 SIMULATIONS TO FIND 
# THE AVERAGE PRICE EARNED PER SHARE FOR THE OPTIMAL STRATEGY WITH MOS AND LOS CONSIDERING DRIFT
...
print(f"Optimal strategy (with MOs)       = ${np.mean(avg_price_opt_T):.5f}")
...
print(f"LO-only strategy (no MOs)         = ${np.mean(avg_price_lo_only_T):.5f}")
